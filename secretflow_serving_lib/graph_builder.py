...
def build_serving_tar(
    ...
    if bundle_type == "json":
        ...
        bundle_data = libserving._pb_serialize_bundle(
            json_format.MessageToJson(bundle, indent=0)
        )
