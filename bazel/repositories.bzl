...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "00860d925a9228cb863e40c048f6d0aae2df84cd2126488fc00233ea39406978",
        strip_prefix = "aws-sdk-cpp-1.11.463",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.463.tar.gz",
        ],
    )
