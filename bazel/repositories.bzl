...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "7461f64d28d1887b87fe8130534fb2f60029dbcf42efc85fe6dc571b766a7dfe",
        strip_prefix = "aws-sdk-cpp-1.11.470",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.470.tar.gz",
        ],
    )
