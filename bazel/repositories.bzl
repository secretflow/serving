...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "40141dfbe34d88aa20b64c5bc11701ac088c384ab7ecaf81fd9ebaab7bd06674",
        strip_prefix = "aws-sdk-cpp-1.11.389",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.389.tar.gz",
        ],
    )
