...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "ab5ea97df34f1fa2834406dda2eacb0d8f10e9742b1fee5adda34702b965109a",
        strip_prefix = "aws-sdk-cpp-1.11.391",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.391.tar.gz",
        ],
    )
