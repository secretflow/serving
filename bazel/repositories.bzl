...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "9910fd1f848da9795d4908f38a9aec49541c7702fde3bfe54789dfb71fc9aea2",
        strip_prefix = "aws-sdk-cpp-1.11.434",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.434.tar.gz",
        ],
    )
