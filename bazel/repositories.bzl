...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "33bf070483dbdba3f6866e6113e5649c992c3695cc59c84a8cd6ed2bb30f168f",
        strip_prefix = "aws-sdk-cpp-1.11.472",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.472.tar.gz",
        ],
    )
