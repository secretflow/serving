...
def _com_aws_c_common():
    maybe(
        ...
        urls = [
            "https://github.com/awslabs/aws-c-common/archive/v0.9.25.tar.gz",
        ],
        sha256 = "443f3268387715e6e2c417a87114a6b42873aeeebc793d3f6f631323e7c48a80",
        strip_prefix = "aws-c-common-0.9.25",
