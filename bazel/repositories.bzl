...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "e7f14b86988e07d2d15fe81311040d85e11a370709f0dc0e73ab367bb686e3ee",
        strip_prefix = "aws-sdk-cpp-1.11.429",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.429.tar.gz",
        ],
    )
